...
var Wn = U((Zn, ve) => {
    (function(t2, e, n) {
        ...
        function h(y, w, T) {
            ...
            var C = x(m(w.entropy ? [y, b(e)] : y != null ? y : _(), 3), A),
                S = new p(A),
                N = function() {
...
var nr = sn(er()),
    wo = { width: 1024, height: 1024, points: [], gap: 0, maxQtObjects: 10, maxQtLevels: 4 };
...
function Mo(t2) {
    ...
    let n = Math.pow(2, t2.maxQtLevels),
        r = t2.width / n,
        i = t2.height / n;
...
function So(t2, e, n, r, i, s, a) {
    let o, l, f, u, c, h, p, d, m, x, _, b, y, w, T, A, C, S, N = t2 - i,
        v = n - i,
        M = e - s,
        j = r - s;
...
var be = class {
    ...
    render(e) {
        let n = e == null ? e = new K() : void 0,
            { delaunay: { halfedges: r, inedges: i, hull: s }, circumcenters: a, vectors: o } = this;
        if (s.length <= 1)
            return null;
        ...
        for (let u = 0; u < s.length; ++u) {
            l = f, f = s[u];
            let c = Math.floor(i[f] / 3) * 2,
                h = a[c],
                p = a[c + 1],
                d = l * 4,
                m = this._project(h, p, o[d + 2], o[d + 3]);
    ...
    _renderSegment(e, n, r, i, s) {
        let a, o = this._regioncode(e, n),
            l = this._regioncode(r, i);
...
var St = class {
    ...
    _init() {
        ...
        if (e.hull && e.hull.length > 2 && Bo(e)) {
            ...
            let l = this.collinear[0],
                f = this.collinear[this.collinear.length - 1],
                u = [n[2 * l], n[2 * l + 1], n[2 * f], n[2 * f + 1]],
                c = 1e-8 * Math.hypot(u[3] - u[1], u[2] - u[0]);
        ...
        let r = this.halfedges = this._delaunator.halfedges,
    ...
    _step(e, n, r) {
        ...
        let u = e,
            c = Dt(n - f[e * 2], 2) + Dt(r - f[e * 2 + 1], 2),
            h = i[e],
            p = h;
        do {
            let d = l[p],
                m = Dt(n - f[d * 2], 2) + Dt(r - f[d * 2 + 1], 2);
    ...
    render(e) {
        let n = e == null ? e = new K() : void 0,
            { points: r, halfedges: i, triangles: s } = this;
...
var Me = "http://www.w3.org/1999/xhtml",
    vn = { svg: "http://www.w3.org/2000/svg", xhtml: Me, xlink: "http://www.w3.org/1999/xlink", xml: "http://www.w3.org/XML/1998/namespace", xmlns: "http://www.w3.org/2000/xmlns/" };
...
function _r(t2, e) {
    ...
    for (var s = i.length, a = new Array(s), o = new Array(s), l = new Array(s), f = 0; f < s; ++f) {
        var u = r[f],
            c = i[f],
            h = c.length,
            p = as(t2.call(u, u && u.__data__, f, r)),
            d = p.length,
            m = o[f] = new Array(d),
            x = a[f] = new Array(d),
            _ = l[f] = new Array(h);
...
function Yr(t2, e) {
    var n = typeof t2 == "function" ? t2 : Ae(t2),
        r = e == null ? Ns : typeof e == "function" ? e : Ct(e);
    return this.select(function() {
...
function Ps() {
    var t2 = this.cloneNode(false),
        e = this.parentNode;
    return e ? e.insertBefore(t2, this.nextSibling) : t2;
}

function Ds() {
    var t2 = this.cloneNode(true),
        e = this.parentNode;
    return e ? e.insertBefore(t2, this.nextSibling) : t2;
}
...
var re = 0.7,
    ...
    W = "\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)%\\s*",
    Ys = /^#([0-9a-f]{3,8})$/,
    Hs = new RegExp("^rgb\\(" + [qt, qt, qt] + "\\)$"),
    Gs = new RegExp("^rgb\\(" + [W, W, W] + "\\)$"),
    $s = new RegExp("^rgba\\(" + [qt, qt, qt, ie] + "\\)$"),
    Qs = new RegExp("^rgba\\(" + [W, W, W, ie] + "\\)$"),
    Us = new RegExp("^hsl\\(" + [ie, W, W] + "\\)$"),
    Ks = new RegExp("^hsla\\(" + [ie, W, W, ie] + "\\)$"),
...
Se(J, ai, wn(ne, {
    ...
    rgb: function() {
        var t2 = this.h % 360 + (this.h < 0) * 360,
            e = isNaN(t2) || isNaN(this.s) ? 0 : this.s,
            n = this.l,
            r = n + (n < 0.5 ? n : 1 - n) * e,
            i = 2 * n - r;
...
function ta(t2, e, n) {
    return t2 = Math.pow(t2, n), e = Math.pow(e, n) - t2, n = 1 / n,
        function(r) {
...
var Oe = function t(e) {
    ...
    function r(i, s) {
        var a = n((i = Xt(i)).r, (s = Xt(s)).r),
            o = n(i.g, s.g),
            l = n(i.b, s.b),
            f = Ne(i.opacity, s.opacity);
        return function(u) {
...
function In(t2, e) {
    var n = kn.lastIndex = Tn.lastIndex = 0,
        r, i, s, a = -1,
        o = [],
        l = [];
    for (t2 = t2 + "", e = e + "";
        (r = kn.exec(t2)) && (i = Tn.exec(e));)
...
function mi(t2, e, n, r) {
    ...
    return function(f, u) {
        var c = [],
            h = [];
        return f = t2(f), u = t2(u), s(f.translateX, f.translateY, u.translateX, u.translateY, c, h), a(f.rotate, u.rotate, c, h), o(f.skewX, u.skewX, c, h), l(f.scaleX, f.scaleY, u.scaleX, u.scaleY, c, h), f = u = null,
            function(p) {
...
var zt = 0,
    ...
    xi = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t2) {
        setTimeout(t2, 17);
    };
...
function Oa(t2, e) {
    ...
    return function() {
        var s = ct(this, t2),
            a = (this.style.removeProperty(t2), ct(this, t2));
...
function qa(t2, e) {
    ...
    return function() {
        var l = Y(this, t2),
            f = l.on,
            u = l.value[s] == null ? o || (o = zi(e)) : void 0;
...
function Qi(t2) {
    ...
    let e = St.from(t2.points),
        n = e.voronoi([0, 0, t2.width, t2.height]),
        r = [];
...
function Ua(t2, e) {
    let n = t2,
        r = e.slice(0),
        i = (s, a) => Math.atan2(s[1] - n[1], s[0] - n[0]) * 180 / Math.PI - Math.atan2(a[1] - n[1], a[0] - n[0]) * 180 / Math.PI;
    return r.sort(i), r;
}
var Zi = sn(Ki()),
    Ka = { width: 200, height: 200, resolution: 8, xInc: 0.01, yInc: 0.01, seed: Math.random() * 1e3 };
...
function Za(t2, e, n, r, i) {
    return function(s) {
        let a = Math.floor(Wi(s.x, 0, e - 1) / i),
            o = Math.floor(Wi(s.y, 0, n - 1) / i);
        return t2[a + o * r];
    };
}
